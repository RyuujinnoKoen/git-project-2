...
// For an array, specify the index number, to add an event listener
    ...
    fetch(`https://api.tvmaze.com/search/shows?q=${searchInput.value}`)
        ...
        .then((data) => {
            ...
            data.forEach((tvshow) => {
                ...
                tvshowLinkElement.href = `file:///C:/Users/Student2022/Desktop/VSC/Week6/git-project-2/GroupProject/html/moviepage.html?movieid=${tvshow.show.id}`;
